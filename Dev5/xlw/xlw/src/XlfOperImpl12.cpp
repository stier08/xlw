...
{
    int err = XlfExcel::Instance().XlfExcel::Instance().Call12(xlFree, NULL, 1, xlfOper.lpxloper12_);
    if (err != xlretSuccess)
...
{
    XlfOper xlType(type);
    int xlret = XlfExcel::Instance().Call12(xlCoerce, result.lpxloper12_, 2, xlfOper.lpxloper12_, xlType.lpxloper12_);
    return xlret;
}
