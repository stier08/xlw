...
//! Handles creation and destruction of temporary memory
/*!
This function must be called from the xll's DllMain

The autogenerated code handles this by using the XLW_DLLMAIN_IMPL macro.

If you need to use your own DllMain for whatever reason then you must first
hash define XLW_OWN_DLLMAIN in your project and ensure you call
DllMainTls from within your implementation

*/
BOOL DllMainTls(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved);

#ifndef XLW_OWN_DLLMAIN
#define XLW_DLLMAIN_IMPL  \
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved) { \
    return DllMainTls(hinstDLL, fdwReason, lpvReserved); \
}
#else
#define XLW_DLLMAIN_IMPL
#endif
